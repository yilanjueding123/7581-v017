...
#define Long_Single_width              192//320//192// 64 3s
#define Long_Single_width_power_2s     128//192// 64 2s
#define Long_Single_width_power_6s     384//192// 64 6s
...
#define PERI_POWER_OFF                  60*128/PERI_TIME_INTERVAL_AD_DETECT//1MIN
