...
// GPIO
	...
	#endif
	#define SENSOR_FLIP				        0 //扜砉芛腔芞砉腔給蛌      
	#define USE_G_SENSOR_NAME		        G_SENSOR_DA380 	
	#define USE_G_SENSOR_ACTIVE				0
	#define CPU_DRAW_TIME_STAMP_BLACK_EDGE	0
...
#define CAPTURE_KEY 					IO_C14
	...
	#define TV_DET_ENABLE					1
    #define	TV_DET_ACTIVE			        0      //tv_detect active level
    #define AV_IN_DET                     	IO_C14//IO_F15//IO_A14 
...
#if 1
    #define LED1							IO_A4//IO_C15//IO_A0//IO_D10 g
    #define LED2							IO_A5//IO_B5//IO_B0////IO_C15//IO_C14//IO_C14//IO_C14//IO_C14//IO_C14//IO_A1//IO_D13 red

	#define M_LED_0                         IO_E1
	#define M_LED_1                         IO_E2
	#define M_LED_2                         IO_E3
	#define M_LED_3                         IO_E4
	#define M_LED_4                         IO_E5
	#define M_LED_5                         IO_E6
	#define M_LED_6                         IO_E7
...
#define CHARGE_PIN	                        IO_C13
    ...
    #define PRODUCT_NUM                     7581
	#define PRODUCT_DATA                    20170621
	#define PROGRAM_VERSION_NUM             17
#endif
