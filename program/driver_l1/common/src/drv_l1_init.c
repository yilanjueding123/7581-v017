...
//DBG_PRINT("wwj: R_IOH_BUFFER == 0x%x\r\n", R_IOH_BUFFER);
  ...
  //#endif
	...
	gpio_init_io(M_LED_5, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_5, ATTRIBUTE_HIGH);
  	gpio_write_io(M_LED_5, DATA_HIGH);

	gpio_init_io(M_LED_6, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_6, ATTRIBUTE_HIGH);
